...
from src.log_to_partial_orders import VARIANT_FREQUENCY_KEY, transform_log_to_partially_ordered_variants
...
if __name__ == "__main__":
    ...
    powl_model = mine_powl_from_partial_orders(partial_orders)
